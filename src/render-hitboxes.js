...
if (core.isModLoaded('render-hitboxes')) {
  console.error(
    `[${sc.twk.modName}] Please uninstall my other mod "Render Hitboxes". Its functionality is now included in the pack, so it is now obselete. The pack is incompatible with it!`,
  );
}
